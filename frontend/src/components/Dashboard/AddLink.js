...
const AddLink = ({ onAddLink }) => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <form onSubmit={handleSubmit} className="bg-white p-6 rounded border border-gray-300 shadow-2xl w-full max-w-md rounded">
        ...
        <div className="flex justify-center">
          <button type="submit" className="btn bg-violet-800 hover:bg-violet-600 w-72 rounded-2xl text-white">Add Link</button>
        </div>
      </form>
    </div>
  );
